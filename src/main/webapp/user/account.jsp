                    ...
                    <div class="profile-usertitle justify-content-center">
                        <div class="profile-usertitle-name">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#exampleModalCenter"><fmt:message
                                    key="account.replenishment"/>
                            </button>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form method="post"
                                                      action='<c:url value="/user/account_replenishment" />'
                                                      style="display:inline;">
                    ...
                    <c:forEach var="tariff" items="${user.getTariffs()}">
                        <tr class="clickable-row">
                            ...
                            <td style="text-align: right;">
                                <form method="post" action='<c:url value="/user/unsubscribe" />'
                                      style="display:inline;">
                                    <input type="hidden" name="tariffId" value="${tariff.getId()}">
                                    <input type="submit" class="btn btn-info col-4"
                                           value=" <fmt:message key="tariff.unsubscribe"/>">
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
